    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-top__wrap">
                <a href="mailto:{{ $landing->data['email'] }}" class="header-top__link">
                    ...
                    <span>{{ $landing->data['email'] }}</span>
                </a>
                <a href="tel:{{ $landing->data['phone'] }}" class="header-top__link">
